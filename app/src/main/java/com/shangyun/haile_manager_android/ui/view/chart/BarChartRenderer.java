...
package com.shangyun.haile_manager_android.ui.view.chart;
    ...
    protected void drawDataSet(Canvas c, IBarDataSet dataSet, int index) {
        ...
        for (int j = 0; j < buffer.size(); j += 4) {
            if (this.mViewPortHandler.isInBoundsLeft(buffer.buffer[j + 2])) {
                ...
                c.drawRoundRect(rectF, 100, 100f, mRenderPaint);
                float v = (buffer.buffer[j + 3] - buffer.buffer[j + 1]) * 0.5f;
                c.drawRect(buffer.buffer[j], buffer.buffer[j + 1] + v, buffer.buffer[j + 2], buffer.buffer[j + 3], this.mRenderPaint);
                if (drawBorder) {
        ...
        for (int var6 = 0; var6 < var5; ++var6) {
            ...
            if (set != null && set.isHighlightEnabled()) {
                ...
                if (this.isInBoundsX(e, set)) {
                    ...
                    c.drawRoundRect(this.mBarRect, 100, 100f, mHighlightPaint);
                    float v = (mBarRect.bottom - mBarRect.top) * 0.5f;
