...
object BusEvents {
    ...
    const val PT_LIST_STATUS = "pt_list_change"
    const val PT_DETAILS_STATUS = "pt_detail_change"
    ...
    const val DEVICE_UNBIND_APPROVE_STATUS = "device_unbind_approve_status"
