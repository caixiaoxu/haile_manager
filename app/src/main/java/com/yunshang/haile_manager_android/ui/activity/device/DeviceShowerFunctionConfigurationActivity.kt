...
class DeviceShowerFunctionConfigurationActivity :
    BaseBusinessActivity<ActivityDeviceShowerFunctionConfigurationBinding, DeviceShowerFunctionConfigurationViewModel>(
    ...
    private fun showDeviceConfigureTipView(view: View, tip: String) {
        val mPopupBinding =
            PopupDeviceConfigureTipBinding.inflate(LayoutInflater.from(this@DeviceShowerFunctionConfigurationActivity))
        val popupWindow = TranslucencePopupWindow(
            mPopupBinding.root,
            window,
            DimensionUtils.dip2px(this@DeviceShowerFunctionConfigurationActivity, 136f),
            alpha = 1f
        )
        ...
        popupWindow.showAsAbove(
            ...
            view.width - DimensionUtils.dip2px(
                this@DeviceShowerFunctionConfigurationActivity,
                33f
            ),
        )
    }
