...
import com.yunshang.haile_manager_android.business.vm.ShopNearByOrderSettingViewModel
import com.yunshang.haile_manager_android.business.vm.ShopSelfCleanSettingViewModel
import com.yunshang.haile_manager_android.data.arguments.IntentParams
import com.yunshang.haile_manager_android.data.arguments.SearchSelectParam
import com.yunshang.haile_manager_android.databinding.ActivityShopNearByOrderSettingBinding
import com.yunshang.haile_manager_android.databinding.ActivityShopSelfCleanSettingBinding
import com.yunshang.haile_manager_android.ui.activity.BaseBusinessActivity
import com.yunshang.haile_manager_android.ui.activity.common.SearchSelectRadioActivity

class ShopNearByOrderSettingActivity :
    BaseBusinessActivity<ActivityShopNearByOrderSettingBinding, ShopNearByOrderSettingViewModel>(
        ShopNearByOrderSettingViewModel::class.java, BR.vm
    ) {
    ...
    override fun layoutId(): Int = R.layout.activity_shop_near_by_order_setting
    ...
    override fun initView() {
        ...
        mBinding.llShopBatchFlowSettingShops.setOnClickListener {
            startSearchSelect.launch(
                Intent(
                    this@ShopNearByOrderSettingActivity,
