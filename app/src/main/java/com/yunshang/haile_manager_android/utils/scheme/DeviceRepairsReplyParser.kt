 ...
 * 作者姓名 修改时间 版本号 描述
 */
class DeviceRepairsReplyParser : ISchemeURLParser {

    override fun parsePath(): String =
        "com.yunshang.haile_manager_android.ui.activity.device.DeviceRepairsReplyActivity"

    override fun parseParams(params: String): Bundle {
        val bundle = Bundle()
        // 解析
        SchemeURLHelper.parseParam(params, "repairsId")?.let {
            try {
